...
class CRM_Membersonlyevent_DAO_MembersOnlyEvent extends CRM_Core_DAO
{
   ...
   * @static
   */
  static $_tableName = 'civicrm_membersonlyevent';
  /**
  ...
  public $event_id;
  /**
   * Foreign key for the Price field id
   *
   * @var int unsigned
   */
   ...
   *
   * @access public
   * @return civicrm_membersonlyevent
   */
  function __construct()
  {
    $this->__table = 'civicrm_membersonlyevent';
    parent::__construct();
  }
  /**
    ...
    if (!(self::$_import)) {
      ...
      foreach($fields as $name => $field) {
        if (CRM_Utils_Array::value('import', $field)) {
          if ($prefix) {
            self::$_import['membersonlyevent'] = & $fields[$name];
          } else {
    ...
    if (!(self::$_export)) {
      ...
      foreach($fields as $name => $field) {
        if (CRM_Utils_Array::value('export', $field)) {
          if ($prefix) {
            self::$_export['membersonlyevent'] = & $fields[$name];
          } else {
